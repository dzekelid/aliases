...
- name: AWS Identity and Access Management API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/aliases/master/_listings/aws-identity-and-access-management/action-listaccountaliases-get.md
x-common:
- type: x-change-log
